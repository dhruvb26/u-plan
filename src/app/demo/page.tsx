...
const Demo = () => {
  ...
  return (
    <main className="absolute inset-0">
      ...
      <div className="absolute mt-4 border border-white justify-center top-4 items-center right-4 z-10 bg-white p-4 rounded-xl bg-opacity-0 flex flex-row space-x-2">
        <form
